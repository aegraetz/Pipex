...
/*   Updated: 2022/07/21 15:10:04 by agraetz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parentproc(char **argv, char **envp, int *fd)
{
	...
	file2 = open(argv[4], O_WRONLY |
			O_CREAT | O_TRUNC, 0777);//create or open file2 ready to be read and written to and if there is already something in it, write over it
	if (file2 == -1)
		error();
